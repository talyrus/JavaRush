...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        for (int i = 0; i < listUpperCase.size(); i++)
        {
            ...
            {
                /*String rezEven = listUpperCase.get(i) + " " + listUpperCase.get(i);
                listNew.add(rezEven);*/
                listNew.add(listUpperCase.get(i) + " " + listUpperCase.get(i));
            }
            else
            {
                /*String rezOdd = listUpperCase.get(i)+ " " + listUpperCase.get(i)+ " " + listUpperCase.get(i);
                listNew.add(rezOdd);*/
                listNew.add(listUpperCase.get(i) + " " + listUpperCase.get(i)+ " " + listUpperCase.get(i));
            }
        }
